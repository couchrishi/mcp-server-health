...
def assess_security(input_file="discovered_mcp_servers_with_metadata.json", 
    ...
    Args:
        ...
        assessment_type (str): Type of assessment to perform: "container", "api", or "all"
...
def main():
    ...
    parser.add_argument("--type", choices=["container", "api", "all"], default="all", help="Type of assessment to perform")
    
    args = parser.parse_args()
    
    assess_security(args.input, args.output, args.type)
